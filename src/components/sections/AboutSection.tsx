        ...
        <SectionContainer id="about" background="charcoal-dark">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
                ...
                <div className="lg:col-span-2">
                    <div className="aspect-[3/4] rounded-2xl bg-gradient-to-br from-gray-100 to-gray-200 border border-gold/20 flex items-center justify-center overflow-hidden">
