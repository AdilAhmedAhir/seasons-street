...
export default function Footer() {
    return (
        <footer id="contact" className="bg-charcoal-dark border-t border-white/5">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-text-muted">
                            <li className="flex items-start gap-2">
                                <svg className="w-4 h-4 mt-0.5 text-gold shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                                info@seasonsstreet.com
                            </li>
                            <li className="flex items-start gap-2">
                                <svg className="w-4 h-4 mt-0.5 text-gold shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="flex gap-3">
                            {socialLinks.map((social) => (
                                <a
                                    ...
                                    className="p-2.5 rounded-lg bg-white/5 text-text-muted hover:text-gold hover:bg-gold/10 transition-all duration-200"
                                >
                                    {social.icon}
                                </a>
                            ))}
